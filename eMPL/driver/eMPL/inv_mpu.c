...
int h7_i2c_write(unsigned char slave_addr, unsigned char reg_addr,unsigned char length, unsigned char const *data){
	volatile int32_t ret = 0;
	slave_addr = slave_addr << 1;
	ret =  HAL_I2C_Mem_Write(&hi2c2,slave_addr,reg_addr,I2C_MEMADD_SIZE_8BIT,(uint8_t*)data,length,400);
	return ret;
}

int h7_i2c_read(unsigned char slave_addr, unsigned char reg_addr,unsigned char length,unsigned char *data){
	volatile int32_t ret = 0;
	slave_addr = slave_addr << 1;
	ret =  HAL_I2C_Mem_Read(&hi2c2,slave_addr,reg_addr,I2C_MEMADD_SIZE_8BIT,(uint8_t*)data,length,400);
  return ret;
}
...
#define i2c_write   h7_i2c_write
#define i2c_read    h7_i2c_read 
